...
def main():
    ...
    mems_alloc = np.array([1600, 1930]) - 40 # ~40MiB needed for cupy on every GPU!
    ...
    dims = [train_x.shape[0], 3600, 300, 10]
    ...
    print("types are Y: {}, and X {}".format(str(type(train_y)), str(type(train_x))))        
